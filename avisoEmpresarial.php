...
<body>
    ...
    <main class="page">
        ...
        <div class="container">
            ...
            <h3 align="center">Registro para el Diplomado en Educación Financiera para instituciones que tienen
                registrado un grupo</h3>
                <div class="alert alert-danger">Algunos campos no fueron iguales o quedaron incompletos</div>
            <div>&nbsp;</div>
            <form role="form" action="registrarEmpresarial.php" method="post">
                <div class="contenedor_registro">
                    ...
                    <div class="form-group col-md-6">
                        <label for="sexo">Grupo</label> <abbr title="Este campo es obligatorio"
                            aria-label="required">
                            <font color="red">*</font>
                        </abbr>
                    ...
                    <div class="form-group col-md-4">
                        <label for="edad">Selecciona tu edad:</label> <abbr title="Este campo es obligatorio"
                            aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                    ...
                    <div class="form-group col-md-6">
                        <label class="control-label" for="text">Ingresa número de empleado/control:</label> <abbr
                            title="Este campo es obligatorio" aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                        <input class="form-control" id="mat" name="mat" placeholder="numero de Empleado" type="text" required>
                    </div>
                    <div class="form-group col-md-4">
