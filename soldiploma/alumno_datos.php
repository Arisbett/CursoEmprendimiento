...
if($id_alumno>0){
    ...
    $alumno =  select("c.nombreUniv_Inst,a.*", "alumno a,grupo c", "c.idGrupo=a.idGrupo and a.idAlumno=$id_alumno", "", "");
    $estados = select("id_estado,estado", "states", "", "", "");
    //$areas = select("idArea,nombreArea", "areas", "", "", "");
...
<div class="row">
    ...
    <!--<div class="col-md-4">
        ...
        <option value="<?php echo $estados[$i]["id_estado"]; ?>" <?php echo ($alumno[0]["estado"]==$estados[$i]["id_estado"]?"selected":""); ?>><?php echo ($estados[$i]["estado"]); ?>    
        <? } ?> 
        </select>
    ...
    <div class="col-md-4">
        <div class="form-group">
        <label for="name">Grupo: <br><?php echo ($alumno[0]["nombreUniv_Inst"]); ?> </label>
    ...
    <div class="col-md-4">
        ...
        <label for="name">Sexo<span id="asterisco_sexo" class="form-text">*</span>:
            <select name="sexo" id="sexo" class="form-control" required>
                            ...
                            <option value="F" <?php echo ($alumno[0]["sexo"]=="F"?"selected":""); ?>>Femenino</option>
                            <option value="M" <?php echo ($alumno[0]["sexo"]=="M"?"selected":""); ?>>Masculino</option>
                            <option value="O" <?php echo ($alumno[0]["sexo"]=="O"?"selected":""); ?>>Otro</option>
                        </select>
