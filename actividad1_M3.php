...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main class="page">
        ...
        <div class="container">
            ...
            <div>&nbsp;</div>
            <?php
            $comando = $con->query("SELECT * FROM actividades WHERE id_actividad=3");
            $comando->execute();
...
<p>Obtenido este resultado, podrás pasar a cursar el siguiente nivel. </p>
            ...
            <form role="form" name="actividad7">
                <div class="form-group pregunta1">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=20");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=1");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=21");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php  
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=2");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta3">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=22");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=3");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta4">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=23");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=4");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta5">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=24");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=5");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta6">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=25");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=6");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta7">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=26");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=7");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta8">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=27");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=8");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta9">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=28");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=9");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta10">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=29");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=3 AND id_pregunta=10");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
...
<div class="form-group">
	...
	<p class="pull-right">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='Modulos.php?p=3'">Regresar</button>
...
if(tipo==1){
    ...
    document.getElementById("err_"+element).innerHTML='';
           ...
           $idAl=$_SESSION['idAlumno'];
           $actividad=$con->query("SELECT intentos FROM `actividad1_m3` WHERE idAlumno=$idAl");
           $actividad->execute();
           $resultadoA = $actividad->fetchAll(PDO::FETCH_ASSOC);
           $calificacion_actividad3 = $resultadoA[0]["intentos"];
           //var_export($calificacion_actividad3);
            if ($calificacion_actividad3 >= 4) {
             ...
             //Acumulaste $por %  para tu promedio final del Módulo III, ¡prepárate para tu evaluación!
             ...
             //Para que la actividad sea promediada, se requiere que TODAS LAS RESPUESTAS SEAN CORRECTAS, si es necesario vuelva a leer la información e intente nuevamente las veces que sea necesario.
                ...
                $idGen;
                $intentos=1;
                $query = Conexion::conectar()->prepare("SELECT idAlumno FROM actividad1_m3 WHERE idAlumno =:idAl");
              $query->bindParam(':idAl', $idAl, PDO::PARAM_STR);
              $query->execute();
              $total = $query->rowCount();

              if ($total>=1) {
                $query = Conexion::conectar()->prepare("UPDATE actividad1_m3 SET Respuesta1 = :r1, Respuesta2 = :r2, Respuesta3 = :r3, Respuesta4 = :r4, Respuesta5 = :r5, Respuesta6 = :r6, Respuesta7 = :r7, Respuesta8 = :r8, Respuesta9 = :r9, Respuesta10 = :r10, 
                Calificacion = :cal, fecha_registro=NOW(), intentos = (intentos + 1) WHERE actividad1_m3.IdAlumno = :idAl");
                ...
                $queryAc = Conexion::conectar()->prepare("UPDATE `boleta` SET `Calificacion3` = :cal WHERE boleta.IdAlumno = :idAl");
                $queryAc->bindParam(':cal', $por, PDO::PARAM_STR);
                $queryAc->bindParam(':idAl', $idAl, PDO::PARAM_STR);
                $queryAc->execute();

              }else {
                $query = Conexion::conectar()->prepare("INSERT INTO actividad1_m3 (Respuesta1, Respuesta2, Respuesta3, Respuesta4, Respuesta5, Respuesta6, Respuesta7, Respuesta8, Respuesta9, Respuesta10, Calificacion,idAlumno, idGeneracion, intentos) VALUES(:r1,:r2,:r3,:r4,:r5,:r6,:r7,:r8,:r9,:r10,:cal,:idAl,:idGen, :intentos)");
                $query->bindParam(':r1', $r1, PDO::PARAM_STR);
                $query->bindParam(':r2', $r2, PDO::PARAM_STR);
                $query->bindParam(':r3', $r3, PDO::PARAM_STR);
                $query->bindParam(':r4', $r4, PDO::PARAM_STR);
                ...
                $queryAc->execute();
                    ...
                    $queryIn = Conexion::conectar()->prepare("INSERT INTO boleta (idAlumno,Calificacion3) VALUES(:idAl,:cal)");
