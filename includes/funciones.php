...
function select($campos, $tablas, $where="1", $order="1", $limit="") {
	...
	$tmp   = array("if(","IF(","delete ","DELETE ","insert ","INSERT ","drop ","DROP ","EXTRACTVALUE","extractvalue","/**//**/","/**/","0x","_SCHEMA",'~',"ALTER","alter","table","TABLE","ETL(","etl(","ETL (","etl (","FLOOR","floor","RAND(","RAND (","rand(","rand (","ROW(","row(");
     $entra=1;
