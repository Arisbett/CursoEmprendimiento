...
<body>
    ...
    <main class="page">
        ...
        <div class="container">
            ...
            <h3 align="left">Registro para el Diplomado de Educaión Financiera para personal de CONDUSEF</h3>

            <div>&nbsp;</div>
            <form role="form" action="registrarAreaCond.php" method="post">
                <div class="contenedor_registro">
                    ...
                    <div class="form-group col-md-2">
                        <label for="edad">Edad:</label> <abbr title="Este campo es obligatorio"
                            aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                    ...
                    <div class="form-group col-md-4">
                        <label class="control-label" for="text">Ingresa tu número de teléfono:</label> <abbr
                            title="Este campo es obligatorio" aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                    ...
                    <div class="form-group col-md-4">
                        <label class="control-label" for="text">Ingresa un número de empleado:</label> <abbr
                            title="Este campo es obligatorio" aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                        <input class="form-control" id="numEmp" name="numEmp" placeholder="Número de empleado"
                            type="text" required>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="nEst" id="nEst" class="form-control" required>
                            ...
                            <option value="Educacion Media Superior">Educación Media Superior</option>
                    ...
                    <div class="form-group col-md-6">
                        <label for="tCand">Area de Adscripción:</label> <abbr title="Este campo es obligatorio"
                            aria-label="required">
                            <font color="black">*</font>
                        </abbr>
                        <?php
                                     $comando = $con->query("SELECT * FROM `areas` ORDER BY idArea ASC");
                                    $comando->execute();
                                    $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                    ?>
                        <select name="tCand" id="tCand" class="form-control" required>
                        <option style="font-size:10pt;" value="">Elige una opción</option>
                        <?php foreach($resultado AS $row){?>
                            <option style="font-size:8pt;" value="<?php echo $row ['nombreArea']?>"><?php echo $row ['nombreArea']?></option>
                            <?php }?>
                    ...
                    <div align="center">
                        <label for="info" name="">Deseo recibir información de Educación Financiera.</label> <br />
