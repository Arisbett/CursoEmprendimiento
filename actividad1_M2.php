...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main class="page">
        ...
        <div class="container">
            ...
            <div>&nbsp;</div>
            <?php
            $comando = $con->query("SELECT * FROM actividades WHERE id_actividad=2");
            $comando->execute();
            ...
            <form role="form" name="actividad7">
                <div class="form-group pregunta1">
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=1");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=2");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta3">
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=3");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta4">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=13");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=4");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta5">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=14");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=5");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta6">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=15");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=6");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta7">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=16");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=7");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta8">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=17");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=8");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta9">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=18");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=9");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta10">
                             <?php
                             $comando = $con->query("SELECT pregunta FROM actividad_preguntas WHERE id_pregunta=19");
                             $comando->execute();
                             $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                ?>
                         <?php foreach($resultado AS $row){?>
                        ...
                        <div class="checkbox">
                            ...
                            <?php
                                $comando = $con->query("SELECT * FROM actividad_opciones WHERE id_actividad=2 AND id_pregunta=10");
                                $comando->execute();
                                $resultado = $comando->fetchAll(PDO::FETCH_ASSOC);
                                        ?>
                            <?php   $i=0;
...
<div class="form-group">
	...
	<p class="pull-right">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='Modulos.php?p=2'">Regresar</button>
...
if(tipo==1){
    ...
    document.getElementById("err_"+element).innerHTML='';
           ...
           $idAl=$_SESSION['idAlumno'];
                            $actividad=$con->query("SELECT intentos FROM `actividad1_m2` WHERE idAlumno=$idAl");
                            $actividad->execute();
                            $resultadoA = $actividad->fetchAll(PDO::FETCH_ASSOC);
                            $calificacion_actividad2 = $resultadoA[0]["intentos"];
//var_export($calificacion_actividad2);
           if ($calificacion_actividad2 >= 4) {
             ...
             //Acumulaste $por %  para tu promedio final del Módulo II, ¡prepárate para tu evaluación!
             ...
             //Para que la actividad sea promediada, se requiere que TODAS LAS RESPUESTAS SEAN CORRECTAS, si es necesario vuelva a leer la información e intente nuevamente las veces que sea necesario.
                ...
                $query = Conexion::conectar()->prepare("SELECT idAlumno FROM actividad1_m2 WHERE idAlumno =:idAl");
              $query->bindParam(':idAl', $idAl, PDO::PARAM_STR);
              $query->execute();
              $total = $query->rowCount();

              if ($total>=1) {
                $query = Conexion::conectar()->prepare("UPDATE actividad1_m2 SET Respuesta1 = :r1, Respuesta2 = :r2, Respuesta3 = :r3, Respuesta4 = :r4, Respuesta5 = :r5, Respuesta6 = :r6, Respuesta7 = :r7, Respuesta8 = :r8, Respuesta9 = :r9, Respuesta10 = :r10, 
                Calificacion = :cal, fecha_registro=NOW(), intentos = (intentos + 1) WHERE actividad1_m2.IdAlumno = :idAl");
                ...
                $queryAc = Conexion::conectar()->prepare("UPDATE `boleta` SET `Calificacion2` = :cal WHERE boleta.IdAlumno = :idAl");
                $queryAc->bindParam(':cal', $por, PDO::PARAM_STR);
                $queryAc->bindParam(':idAl', $idAl, PDO::PARAM_STR);
                $queryAc->execute();

              }else {
                $query = Conexion::conectar()->prepare("INSERT INTO actividad1_m2 (Respuesta1, Respuesta2, Respuesta3, Respuesta4, Respuesta5, Respuesta6, Respuesta7, Respuesta8, Respuesta9, Respuesta10, Calificacion,idAlumno, idGeneracion, intentos) VALUES(:r1,:r2,:r3,:r4,:r5,:r6,:r7,:r8,:r9,:r10,:cal,:idAl,:idGen, :intentos)");
                $query->bindParam(':r1', $r1, PDO::PARAM_STR);
                $query->bindParam(':r2', $r2, PDO::PARAM_STR);
                $query->bindParam(':r3', $r3, PDO::PARAM_STR);
                $query->bindParam(':r4', $r4, PDO::PARAM_STR);
                ...
                if($totalc>=1){
                    ...
                    $queryIn = Conexion::conectar()->prepare("INSERT INTO boleta (idAlumno Calificacion2) VALUES(:idAl,:cal)");
